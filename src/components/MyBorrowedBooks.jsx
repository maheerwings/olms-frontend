...
const MyBorrowedBooks = () => {
  ...
  // Filter logic
  const [filter, setFilter] = useState("returned"); // "returned" or "nonReturned"
                ...
                {booksToDisplay.map((book, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      {formatDateAndTime(book.borrowedDate)}
                    </td>
                    <td className="px-4 py-2">
                      {formatDateAndTime(book.dueDate)}
                    </td>
                    <td className="px-4 py-2">
