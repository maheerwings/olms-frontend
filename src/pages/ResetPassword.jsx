  ...
  return (
    <>
      <div className="flex flex-col justify-center md:flex-row h-screen">
        {/* Left Section */}
        <div className="hidden w-full md:w-1/2 bg-[#689F38] text-white 
        md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] 
        rounded-br-[80px]">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
          <Link
            ...
            top-10 -right-28 hover:bg-[#689F38] hover:text-white transition duration-300"
          >
            Back
          </Link>
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleResetPassword}>
              ...
              <button
                type="submit"
                className="border-2 mt-5 py-3 border-[#689F38] w-full font-semibold 
                bg-black text-white rounded-lg hover:bg-white hover:text-[#689F38] 
                transition"
              >
                RESET PASSWORD
              </button>
