    ...
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8">
        <div className="max-w-sm w-full">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="border-2 mt-5 border-[#689F38] w-full font-semibold bg-[#689F38] 
      ...
      flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
        <div className="text-center h-[376px]">
          ...
          <Link
            to={"/register"}
            className="border-2 rounded-lg font-semibold border-white 
            py-2 px-8 hover:bg-white hover:text-[#689F38] transition"
          >
            SIGN UP
          </Link>
        </div>
